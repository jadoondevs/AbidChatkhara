...
to `main` as each lands. **Status: platform, the money module, and identity
(users, PIN login, audit log) are done.** Ordering, billing, partner
allocation, and everything after them are not built yet — see
